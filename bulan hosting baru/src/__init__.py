...
def _logo():
    cols = [Colors.GREEN, Colors.GREEN, Colors.GREEN, Colors.GREEN, Colors.GREEN, Colors.GREEN, Fore.LIGHTMAGENTA_EX]
    banner = r"""
 █████  ██     ██ ███████ ███████ ███████  ██████  ██    ██  █████  ██████  
██   ██ ██     ██ ██           ██ ██      ██    ██ ██    ██ ██   ██ ██   ██ 
███████ ██  █  ██ ███████     ██  ███████ ██    ██ ██    ██ ███████ ██   ██ 
...
def _banner():
    print(_logo())
    print(f"{Colors.GREEN} moonbix ")
    print(f"{Colors.GREEN} CP : {Colors.WHITE}LekTugiman")
